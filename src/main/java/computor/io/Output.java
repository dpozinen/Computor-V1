...
public final class Output {
	...
	public static final Output	ALL_REAL_NUMBERS	= new Output("All real numbers are solutions");
	private static final String	POSITIVE_DISC_MSG	= "Discriminant is strictly positive, the two solutions are:%nx1 = %s%nx2 = %s";
	private static final String	ZERO_DISC_MSG		= "Discriminant is zero, the solution is:%nx1 = %s";
	private static final String	SIMPLE_EQUATION_MSG	= "The solution is:%nx = %s";
